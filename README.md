You can see the categories when you log in to Google Photos. I tried to make it like the technique used by Google.Here use NASNet-large free trin model.
